...
/**
 * 调用 {@link EHiRouter.Builder#navigate()}之后拿到的对象,可以在其中拿到请求对象 {@link EHiRouterRequest}
 * 和 取消这个路由请求
 * note: 如果发起路由的时候由于参数不合格导致 {@link EHiRouterRequest} 对象构建失败,
 * 这时候会返回一个空实现 {@link EHiRouter#emptyNavigationDisposable} 对象,
