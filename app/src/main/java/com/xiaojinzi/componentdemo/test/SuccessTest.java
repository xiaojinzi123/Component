...
public class SuccessTest implements TestExecutor {
    ...
    public Completable execute(TestContext testContext) {
        ...
        return Completable.concatArray(
                ...
                testContext.wrapTask(testParameterByte()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterByte")),
                testContext.wrapTask(testParameterShort()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterShort")),
                testContext.wrapTask(testParameterInt()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterInt")),
                testContext.wrapTask(testParameterLong()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterLong")),
                testContext.wrapTask(testParameterFloat()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterFloat")),
                testContext.wrapTask(testParameterDouble()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterDouble")),
                testContext.wrapTask(testParameterBoolean()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterBoolean")),
                testContext.wrapTask(testParameterString()).doOnComplete(() -> testContext.addTaskPassMsg("testParameterString")),
